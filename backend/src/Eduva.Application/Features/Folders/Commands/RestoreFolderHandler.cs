...
{
    public class RestoreFolderHandler : IRequestHandler<RestoreFolderCommand, Unit>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly UserManager<ApplicationUser> _userManager;
        public RestoreFolderHandler(IUnitOfWork unitOfWork,
        ...
        public async Task<Unit> Handle(RestoreFolderCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                throw new AppException(CustomCode.FolderRestoreFailed);
            }
        }
        private async Task<bool> HasPermissionToUpdateFolder(Folder folder, Guid userId)
        {
            ...
            // System Admin can restore any folder
            ...
            if (folder.OwnerType == OwnerType.Class && folder.ClassId.HasValue)
            {
                ...
                // School Admin can restore any folder from their school
