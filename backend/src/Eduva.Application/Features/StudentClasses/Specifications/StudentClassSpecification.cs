...
namespace Eduva.Application.Features.StudentClasses.Specifications
{
    public class StudentClassSpecification : ISpecification<StudentClass>
    {
        ...
        private Func<IQueryable<StudentClass>, IOrderedQueryable<StudentClass>> GetSortOrderFunction(string sortBy, bool isDescending)
        {
        ...
        private Expression<Func<StudentClass, bool>> CombineWithAnd(
        ...
        private Func<IQueryable<StudentClass>, IOrderedQueryable<StudentClass>> GetOrderByFunc<TKey>(
